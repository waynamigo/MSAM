...
import copy
import mmcv
from seqtr.datasets.utils import get_device, extract_data, cpu_to_gpu
...
def parse_args():
    parser = argparse.ArgumentParser(description="msamtrain")
